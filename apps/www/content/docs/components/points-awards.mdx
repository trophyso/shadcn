---
title: Points Awards
description: A points activity feed aligned with Trophy award rows — date, totals, and a per-award trigger (with metric names in tooltips).
---
...
|------|------|---------|-------------|
| `awards` | `PointsAward[]` | Required | Award rows from Trophy `points.awards` (order is up to you; often most recent first) |
